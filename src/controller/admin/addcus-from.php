            ...
            <div class="grid_12">
                <div class="panel-group">
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><label style="font-size:20px;">ส่วนที่ 1 ข้อมูลทั่วไป</label></div>
                            <div class="panel-body">
                        ...
                        <div class="panel panel-default" id="custTexAddress">
                            <div class="panel-heading"><label
                                    style="font-size:20px;">ส่วนที่ 2 ที่อยู่สำหรับวางบิล/ออกใบเสร็จ</label></div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                        ...
                        <div class="panel panel-default" id="custContact">
                            <div class="panel-heading"><label style="font-size:20px;">ส่วนที่ 3 ข้อมูลผู้ติดต่อ</label></div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><label style="font-size:20px;">ส่วนที่ 4 ข้อมูลโซเชียล</label></div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
