...
<div class="modal fade" id="myModalupfile" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
...
$(document).ready(function () {
  ...
  // alert('ddd');
   ...
   $.ajax({
      url: '../../importPackToGo/upload_file.php', //Server script to process data
      type: 'POST',
    ...
    function completeCheckHandler(data)
    {
        var jsonData=JSON.parse(data);
        if (JSON.parse(data) == 'column is not correct')
        {
            $('#alert_text').show();
        ...
        if(jsonData['result']=="success")
        {
            ...
            $('#error_text').show();
            $('#error_text_val').text(jsonData['result']);
