...
<section id="content" style="background-image:url(../../../assets/images/login-bg.png);margin-top:20px; ">
            ...
            <div class="grid_12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="flip responsive-table">
                        <table style="width:100%;height:100%;" class="table table-bordered order-table " id="example" cellspacing="0">
                            <thead>
                            <tr>
                                <th scope="col"><label>ชื่อ</label></th>
                                <th scope="col"><label>เบอร์โทร</label></th>
                                <th scope="col"><label>อีเมล์</label></th>
                                <th scope="col"><label>ที่อยู่</label></th>
                                <th scope="col"></th>
                            </tr>
                            </thead>
...
//                        alert(foo);
                        if (CUST_STATUS == 0) {
                            append = append + "<tr bgcolor=\"#f1f1f1\" style=\"color:#E84A2D;width:50%;\">";
                            // append = append + "<td>" + CID + "</td>";

                            append = append + "<td data-column=\"ชื่อลูกค้า\">" + CNAME + "</td>";
                            append = append + "<td data-column=\"เบอร์โทร\">" + foo + "</td>";
                            append = append + "<td data-column=\"emai\">" + CUST_EMAIL + "</td>";
                            append = append + "<td data-column=\"ที่อยู่\"> " + ADDR + "</td>";
