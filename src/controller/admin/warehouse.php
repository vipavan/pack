                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="">ชื่อคลังสินค้า</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="strwarehouse" placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-5">
                                    ...
                                    <button type="button" id="savewarehouse" class="btn btn-info">ยืนยัน</button>
                                </div>
                            </div>
                        </form>
...
//            alert(warehouse);
            $.post('../../service/getCheckNameWH.php', {whName: warehouse}).done(function (data) {
                var jsonData = JSON.parse(data);
//                alert(JSON.stringify(jsonData));
                var res = jsonData["result"];
                if (res == 0) {
                    if (wh == "") {
                        $.post('../../service/insertNewWarehouse.php', {whName: warehouse}).done(function (data) {
                            var jsonData = JSON.parse(data);
//                        alert(JSON.stringify(jsonData));
                        ...
                        $.post('../../service/updateWarehouse.php', {whName: warehouse,whId:wh}).done(function (data) {
                            var jsonData = JSON.parse(data);
//                        alert(JSON.stringify(jsonData));
                            var statusRes = jsonData["status"];
                            var res1 = jsonData["result"];
        ...
        if (wh != "") {
            $.post('../../service/getWHbyId.php', {whId: wh}).done(function (data) {
                var jsonData = JSON.parse(data);
//                alert(JSON.stringify(jsonData));
                var res = jsonData["result"][0]['C'];
                $('#strwarehouse').val(res);
            });
        }
    });
</script>
