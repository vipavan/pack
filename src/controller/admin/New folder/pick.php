              ...
              <div class="panel panel-default" style="margin-top:20px;">
                ...
                <div class="panel-body">
                  <div class="tab-content">
                    ...
                    <input type="button" id="detailX" class="btn btn-sm" data-toggle="modal" data-target="#myModal"
                    style=" margin-bottom:10px; margin-left:10px; float:left;font-family: 'Athiti', sans-serif; font-weight:700px;"
                    ...
                    <table class="table table-striped table-bordered order-table" id="example_pick">
                      ...
                      <tr style="text-align:center;">
                        <th id="name" style="text-align:center;"><label> เลขที่เอกสาร pick สินค้า</label></th>
                        <!--                                <th style="text-align:center;"><label>เลขที่ Order</label></th>-->
                        <th style="text-align:center;"><label>วันที่ทำรายการ</label></th>
                        <th style="text-align:center; width:170px;"><label>จำนวนรายการสินค้า</label></th>
                  ...
                  <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        name="search" placeholder="Search..">
                        <br><br>
                        <table class="table table-bordered order-table" id="example-cus" style="margin-top:20px;" width="100%">
                          <thead>
                            <tr>
                    ...
                    $.post('../../service/getAllPick.php').done(function (data) {
                      ...
                      if (status == 1) {
                        ...
                        for (i = 0; i < resL; i++) {
                          ...
                          append = append + "<td width='150' style=\"text-align:center;\" class=\"orderDate\">" + subMFD + "</td>";
                          ...
                          append = append +"  <li><a href=\"export.php\" target=\"_blank\"><i class=\"fa fa-print\" aria-hidden=\"true\" ></i> ดาวน์โหลด</a></li>";
                ...
                $(document).ready(function () {
                  ...
                  $('#createPick').click(function () {
                    ...
                    //            });
                    //            alert(JSON.stringify(cells));
                    $.post('../../service/insertNewPicklot.php', {dataGroup: cells, lg: lg}).done(function (data) {
                      var jsonData = JSON.parse(data);
                      //                alert(JSON.stringify(/jsonData));
                ...
                <div class="tab-pane fade" id="tab2default">
                  <input type="text" style="margin-top:20px; margin-bottom:20px;"id="search-inv" class="light-table-filter form-control" data-table="order-table"
                  name="search" placeholder="Search..">

                  <table class="table table-striped table-bordered order-table" id="inv-tab2">
                    <thead>
                      <tr style="text-align:center;">
                        <th id="name" style="text-align:center;"><label> เลขที่เอกสารอินว๊อยซ์</label></th>
                        <th style="text-align:center;"><label>วันที่ เอกสาร</label></th>
                        <th style="text-align:center;"><label>เลขที่รายการสั่งสินค้า</label></th>
                        <th style="text-align:center; width:170px;"><label>ชื่อที่อยู่ผู้ส่ง</label></th>
                        <th style="text-align:center;"><label>ชื่อที่อยู่ผู้รับ</label></th>
                        <th style="text-align:center;"><label>จำนวนสินค้า</label></th>
                        <th style="text-align:center;"><label>หน่วยนับ</label></th>
                        <th style="text-align:center;"><label></label></th>
                    ...
                    <tbody id="">
                      ...
                      <tr>
                        <td  style="text-align:center;">INV2005590003</td>
                        <td  style="text-align:center;">29/07/59</td>

                        <td  style="text-align:center;">OUT2909590004</td>
                        <td>กรรณิกา 29/4 หนองจอก หนองจอก กรุงเทพ 10530</td>
                        <td>อุมลวรรณ 30/03 ถนนเลียบคลองสาม แขวงบ้านเกาะ ปราจีณบุรี 30091</td>
                        <td>2</td>
                        <td></td>
                          <td>พิมพ์</td>
                      </tr>
