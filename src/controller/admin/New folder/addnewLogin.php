                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="control-label col-sm-5" for="">ชื่อผู้ใช้งาน</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="strusername" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" for="">รหัสผ่าน</label>
                                <div class="col-sm-3">
                                    <input type="password" class="form-control" id="strpass" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-5" for="">ยืนยันรหัสผ่าน</label>
                                <div class="col-sm-3">
