          ...
          <div class="grid_12">
            <div class="panel panel-default" style="margin-top:20px;">
              <div class="panel-heading" style="height:53px; background-color:#e1e1e1; width:auto;">
                <label style="font-size:20px; margin-left:40%;">เพิ่มค่าใช้จ่ายในการจัดส่ง</label>
              </div>
              <div class="panel-body">
                <div class="row">
                  <div class="col-lg-5">
                    ...
                    value="บันทึก"> -->
                    <button type="button" onclick="window.location='inventory.php#tab3default'" class="btn btn-sm"
                    style="margin-bottom:10px; margin-left:10px; float:left; font-family: 'Athiti', sans-serif; font-weight:700px;">
                    กลับ
                  </button>
                </div>
                ...
                <div class="col-lg-4">
                  <form class="form-horizontal" role="form">
                    <div class="form-group">
                      <label class="control-label col-sm-4" for="">เลขที่ sale order</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="strTodo" placeholder=""
                    value=" SO001230"   readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-4" for="">วันที่ SO </label>
                      <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-4" for="">DO date</label>
                      <div class="col-sm-8">
                        <input type="date" class="form-control" id="strDo" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-4" for="">PO date</label>
                      <div class="col-sm-8">
                  ...
                  <form class="form-horizontal" role="form">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="strFname +strlname" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-sm-3" for="">ที่อยู่</label>
                        <div class="col-sm-6">
                          <textarea class="form-control" rows="3" id="straddress1"></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-1" for="">มือถือ</label>
                        <div class="col-sm-4">
                      ...
                      <!--                                        <div class="col-sm-4">-->
                      <!--                                            <input type="text" class="form-control" id="strTwitter" placeholder="">-->
                      <!--                                        </div>-->
                      <!---->
                      <!--                                    </div>-->
                    </form>
            ...
            <table class="table" style="margin-top:10px;" id="table">
              ...
              <tr>
                ...
                <td>
                  <label for=""> ค่าหยิบสินค้า </label>
                </td>
                <td>
                  <input type="text" class="form-control" id="strcostpick">
                </td>
                <!-- <td></td> -->
                <td>
            ...
            <table class="table table-bordered  table-hov" id="example" style="margin-top:20px;">
      ...
      function loadData(cid, recvid) {
        $.post("../service/getRecvInfo.php", {cid: cid, recvid: recvid}).done(function (data) {
          ...
          if (statusRes == 1) {
            ...
            $('#strshopnames').val(jsonData["result"][0]['RECV_SHOPNAME']);
