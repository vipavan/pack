                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="tab1default">
                                ...
                                <table class="table table-bordered order-table" id="example">
                                    <thead>
                                    <tr>
                                        <th id="name" style="text-align:center;"><label> ชื่อผู้ใช้</label></th>
                                        <th style="text-align:center;"><label>ชื่อร้านค้า</label></th>
                                        <th style="text-align:center;"><label>ชื่อ-นามสกุล</label></th>
                                        <th style="text-align:center;"><label>สิทธิการใช้งาน</label></th>
                                        <th ></th>
                                    </tr>
                                    </thead>
                                    <tbody id="tb">
                            ...
                            <div class="tab-pane fade" id="tab2default">
                                ...
                                <table class="table table-bordered order-table" id="example-package">
                                    ...
                                    <thead>
                                    <tr>
                                        <th id="name" style="text-align:center;"><label> ชื่อแพ็คเกจ</label></th>
                                        <th style="text-align:center;"><label>ประเภทการวางสินค้า</label></th>
                            ...
                            <div class="tab-pane fade" id="tab3default">
                                ...
                                <table class="table table-bordered order-table" id="example-location">
                                    <thead>
                                    <tr>
                                        <th id="name" style="width:50px; text-align:center;"><label> คลังสินค้า</label></th>
                                        <th style="width:50px; text-align:center; "><label> โลเคชั่น</label></th>
                                        <!-- <th><label></label></th> -->
                            ...
                            <div class="tab-pane fade" id="tab4default">
                                ...
                                <table class="table table-bordered order-table" id="example-category">
                                    <thead>
                                    <tr>
                                        <th id="name" style="text-align:center;"><label> หมวดหมู่สินค้า</label></th>
                ...
                if (status == 1) {
                    ...
                    for (i = 0; i < resL; i++) {
                        ...
                        if (USER_STATUS == 0) {
                            ...
                            append = append + "<td  style=\"text-align:center;\">" + LOGIN_USERNAME + "</td>";
                            append = append + "<td  style=\"text-align:center;\">" + CUST_SHOPNAME + "</td>";
                            append = append + "<td  style=\"text-align:center;\">" + FULLNAME + "</td>";
                            append = append + "<td  style=\"text-align:center;\">" + pri + "</td>";
...
//                alert(JSON.stringify(jsonData));
                ...
                if (status == 1) {
                    ...
                    for (i = 0; i < resL; i++) {
                        ...
                        append = append + "<tr>";
                        append = append + "<td width='50' style=\"text-align:center;\">" + WH_NAME + "</td>";
                        append = append + "<td width='50' style=\"text-align:center;\">" + LOCATION_DESC + "</td>";
...
//                alert(JSON.stringify(jsonData));
                ...
                if (status == 1) {
                    ...
                    for (i = 0; i < resL; i++) {
                        ...
                        append = append + "<tr>";
                        append = append + "<td  style=\"text-align:center;\">" + GOODS_TYPE_DESC + "</td>";
