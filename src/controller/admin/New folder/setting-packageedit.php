            ...
            <div class="panel-body">
              <form class="form-horizontal" role="form">
                <div class="form-group">
                  <label class="control-label col-sm-4" for="">ชื่อแพ็คเกจ:</label>
                  <div class="col-sm-4">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-5">
                    <button type="button"  onclick="window.location='setting-package.php'" id="cancel" class="btn btn-info">ยกเลิก</button>
