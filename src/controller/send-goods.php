                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-12">
                            <table width="100%" class="table  table-bordered order-table" id="example">
                                <thead>
                                <tr>
                                    <th id="name"><label> เลขที่บิล</label></th>
                                    <th><label>วันที่สร้างบิล</label></th>
                                    <th><label>ผู้รับสินค้า</label></th>
                                    <th><label>ที่อยู่จัดส่ง</label></th>
                                    <th><label>จำนวนสินค้าในคำสั่งซื้อ</label></th>
                                    <th><label>สถานะบิล</label></th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody id='tb'>
