              ...
              <div class="panel panel-default" style="margin-top:20px;">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-lg-10">
                        <input type="button" onclick="window.location='send-goods.php'"
                        class="btn btn-sm"
                        style="margin-bottom:10px; margin-left:10px; float:left; font-family: 'Athiti', sans-serif; font-weight:700px;"
                        value="บันทึก">
                        <button type="button" onclick="window.location='send-goods.php'"
                        class="btn btn-sm"
                        style="margin-bottom:10px; margin-left:10px; float:left; font-family: 'Athiti', sans-serif; font-weight:700px;">
                        ยกเลิก
                      </button>
                    ...
                    <div class="col-lg-12">
                      <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <textarea class="form-control" rows="3" id="strAddressShop" placeholder="" ></textarea>
...
//                alert(JSON.stringify(jsonData));
      ...
      var CUST_COMPUTE_NAME = data1[0]["CUST_COMPUTE_NAME"];
      var CUST_SHOPNAME = data1[0]["CUST_SHOPNAME"];
...
//          address2 = address2 + option2 + '<br>';
        if (data2[0]["CUST_ADDRESS2"] != '') {
          address2 = address2 + 'ที่่อยู่  ' + data2[0]["CUST_ADDRESS2"] + ' ';
        }
        if (data2[0]["CUST_SUBDISTRICT2"] != '') {
          address2 = address2 + 'ตำบล ' + data2[0]["CUST_SUBDISTRICT2"] + ' ';
        }
        if (data2[0]["CUST_DISTRICT_DESC2"] != '') {
          address2 = address2 + 'อำเภอ ' + data2[0]["CUST_DISTRICT_DESC2"] + ' ';
        }
        if (data2[0]["CUST_PROVINCE_DESC2"] != '') {
          address2 = address2 + 'จังหวัด ' + data2[0]["CUST_PROVINCE_DESC2"] + ' ';
        }
        if (data2[0]["CUST_ZIPCODE2"] != '') {
          address2 = address2 + 'รหัสไปรษณีย์  ' + data2[0]["CUST_ZIPCODE2"] + ' ';
        }
      } else {
...
//          address2 = address2 + option2 + '<br>';
      ...
      $('#strShopNameShow').val(CUST_SHOPNAME);
      $('#strNameShow').val(CUST_COMPUTE_NAME);
      $('#strAddressShop').val(address2);
      $('#strTexidShop').val(TEXTID);
      $('#stricShop').val(pid);
      $('#strPhone').val(xxx);
      $('#strEmail').val(EMAIL);
