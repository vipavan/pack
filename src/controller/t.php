                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-lg-10">
                        ...
                        value="บันทึก">
                        <button type="button" onclick="window.location='send-goods.php'" class="btn btn-sm"
                        style="margin-bottom:10px; margin-left:10px; float:left; font-family: 'Athiti', sans-serif; font-weight:700px;">
                        ยกเลิก
                      </button>
                    </div>
                      ...
                      <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            ...
                            <!-- ผู้รับสินค้า -->
                <div class="panel-heading">ส่วนที่ 2 ผู้รับสินค้า</div>
                <div class="panel-body">
                  <div class="col-lg-11">
                    <form class="form-horizontal" role="form">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <input type="text" class="form-control" id="straddress1" placeholder="">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <select class="form-control selectpicker show-tick" id="strdistrict">
                            </select>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <input type="text" class="form-control" id="stric" placeholder="">
                          </div>
                        </div>
                  ...
                  <div class="panel-heading">ส่วนที่ 3 เลือกสินค้า</div>
                  <div class="panel-body">
...
<div class="modal fade" id="myModal-add-contact" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h2 class="modal-title"> เพิ่มข้อมูลผู้รับปลายทาง</h2>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          <div class="form-group">
